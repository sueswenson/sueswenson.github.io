...
// BONUS:  8  If the user doesn't enter a number, do not calculate and alert them.
// Hint: append td row 
...
$('#entry').submit(function (event) {
   ...
   var someNewNo = $('#newEntry').val();
    someNewNo = parseFloat(someNewNo);

$('#entries').append('<tr><td></td><td>' + someNewNo + '</td></tr>');
